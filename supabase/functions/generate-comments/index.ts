...
- Commend the STUDENT, or their work, effort or performance — never the subject itself. A subject cannot be commended. Write "[Name] is to be commended on the standard of her work in [Subject]", or "her performance in [Subject] deserves particular commendation". Do NOT write "commend her [Subject]".
...
- Recommend Help Sessions ONLY where the teacher has raised it themselves in their own notes — asked for it, mentioned it, or said in so many words that the student needs that support. Their notes making a subject sound difficult is NOT the same thing and is NOT permission; that is you inferring it again. Where the teacher has raised it, use that exact term, capitalised as "Help Sessions" — it is the school's formal name for its after-hours support, and no paraphrase is acceptable. Phrase it impersonally — "It is recommended that [Name] attends Help Sessions" — and say it ONCE.
